...
select FROM_UNIXTIME(c_time),FROM_UNIXTIME(u_time), * from sentiment_dbd.sentiment_t_distributed where source_url='http://finance.china.com.cn/news/20230224/5946329.shtml' -- pub_source_name='文汇网' order by FROM_UNIXTIME(c_time) DESC
