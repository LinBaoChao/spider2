...
select FROM_UNIXTIME(c_time),FROM_UNIXTIME(u_time), * from sentiment_dbd.sentiment_t_distributed order by FROM_UNIXTIME(c_time) DESC -- final where is_ocr =0 and  pub_source_name='中国网'  